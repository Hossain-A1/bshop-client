          ...
          products
            ...
            .map((item) => (
              <div
                ...
                onClick={() => {
                  navigate.push(
                    `/product/${slugify(item.category)}/${item.slug}`
                  ),
                    setOpenCtg(false);
                }}
              >
                ...
                <div className='p-1'>
                  ...
                  <div className='flex items-center justify-between '>
                    ...
                    <p className=' py-0.5 px-2 md:px-1 border-2 border-blue-700 hover:bg-black hover:text-white duration-300 rounded-full    '>
