...
import { setOpenModal } from "@/features/auth/authSlice";
  ...
  return (
    <>
      {cartItems.length > 0 ? (
            ...
            <div className='flex flex-col w-full lg:flex-[1]'>
              <div className='p-4 w-full border rounded-md shadow-md sticky top-4 bg-white'>
                <div className='w-full'>
                  ...
                  <button onClick={isAuthorized} className='w-full block text-center bg-orange-500 text-white py-2 rounded-md hover:bg-orange-600 mt-4'>
                    Checkout
                  </button>
                </div>
              </div>
        ...
        <div className='flex flex-col gap-2 justify-center items-center md:mt-20 mt-10'>
          <p className=' text-xl md:text-3xl font-medium'>
            Your cart is empty!
          </p>
          <Link
            href='/'
            className='text-sm text-green-500 p-2 border shadow-md rounded'
          >
            Go to Products Page
          </Link>
        </div>
